...
void LGSSvr::controller_profiler_filterctrl( BasicProtocol* p, bool& autorelease)
{
...
void LGSSvr::controller_profiler_analysisctrl( BasicProtocol* p, bool& autorelease)
{
