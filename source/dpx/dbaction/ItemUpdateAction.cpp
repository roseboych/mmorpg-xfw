...
ItemUpdateAction::ItemUpdateAction( S_TIMESTAMP s):inherit( DBACTION_ITEMUPDATE, s),
player_( 0), ret_( 0)
{

}

bool ItemUpdateAction::validate()
{
...
void ItemUpdateAction::run_indbpool( otl_connect *pconn)
{
	try
	{
...
void ItemUpdateAction::run_inmainpool()
{
