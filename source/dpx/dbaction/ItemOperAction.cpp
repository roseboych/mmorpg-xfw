...
ItemOperAction::ItemOperAction( S_TIMESTAMP s):inherit( DBACTION_ITEMOPER, s),
player_( 0), ret_( 0)
{

}

bool ItemOperAction::validate()
{
...
void ItemOperAction::run_indbpool( otl_connect *pconn)
{
	try
	{
...
void ItemOperAction::run_inmainpool()
{
