...
int ACE_TMAIN(int argc, ACE_TCHAR **argv) 
{
	...
	MODULE_LOG_INIT("dpx.properties")

	MODULE_LOG_WARN( MODULE_BOOT, "========dpx server starting-------------------------------------------");

	if( DPXMODULE->init( argc, argv) != 0)
		return 1;

	MODULE_LOG_WARN( MODULE_BOOT, "========dpx server start end------------------------------------------");

	MODULE_LOG_WARN( MODULE_BOOT, "========dpx server begin main loop------------------------------------");
	...
	MODULE_LOG_WARN( MODULE_BOOT, "========dpx server end main loop-------------------------------------");
