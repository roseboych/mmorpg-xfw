...
int ACE_TMAIN(int argc, ACE_TCHAR **argv) 
{
	...
	MODULE_LOG_INIT("rgs.properties")

	MODULE_LOG_WARN( MODULE_BOOT, "========rgs server starting-------------------------------------------");

	if( RGSMODULE->init( argc, argv) != 0)
		return 1;

	MODULE_LOG_WARN( MODULE_BOOT, "========rgs server start end------------------------------------------");

	MODULE_LOG_WARN( MODULE_BOOT, "========rgs server begin main loop------------------------------------");
	...
	MODULE_LOG_WARN( MODULE_BOOT, "========rgs server end main loop-------------------------------------");
