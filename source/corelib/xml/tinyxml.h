...
public:
	...
	*/
	...
	TiXmlNode* FirstChildCData() const;
	TiXmlNode* NextSiblingCData() const;
...
public:
	...
	virtual const char* Parse( const char* p, TiXmlParsingData* data, TiXmlEncoding encoding );
private:
	const char* ReadCDATAText( const char* p, TIXML_STRING * text, bool trimWhiteSpace, const char* startTag, 
